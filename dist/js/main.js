...
function setupDesktopAnimations() {
  ...
  tl.fromTo(".integrate__title", {
    ...
    duration: 1.8,
    stagger: 1
  }, "+=1.2").fromTo(".animate-container.integrate__pic-container .animate__column", {
    y: -600
  }, {
    y: 100,
    opacity: 1,
    duration: 5.5,
    ease: "none"
  }, "-=5").fromTo(".animate-container.integrate__pic-container .animate__column", {
    rotationY: 0,
    opacity: 1,
    ease: "power2.inOut",
    stagger: 0.2
    ...
    stagger: 0.2,
    ease: "power2.out"
  }, "-=0.6").to(".animate-container.ship__pic-container .animate__column", {
    y: -800,
    duration: 2,
    stagger: 0.2,
    ease: "power2.out"
...
function setupMobileAnimations() {
  ...
  tl.fromTo(".integrate__title", {
    ...
    duration: 2,
    stagger: 1
  }, "+=1").fromTo(".animate-container.integrate__pic-container .animate__column", {
    y: -400
  }, {
    y: 300,
    opacity: 1,
    duration: 4,
    ease: "none"
  }, "-=4.5").fromTo(".animate-container.integrate__pic-container .animate__column", {
    rotationY: 0,
    opacity: 1,
    ease: "power2.inOut",
    stagger: 0.2
