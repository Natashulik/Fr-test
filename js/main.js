...
function setupDesktopAnimations() {
  ...
  tl.fromTo(".integrate__title", {
    ...
    duration: 5.4,
    stagger: 3
  }, "+=3.6").fromTo(".animate-container.integrate__pic-container .animate__column", {
    y: -600
  }, {
    y: 100,
    opacity: 1,
    duration: 16.5,
    ease: "none"
  }, "-=15").fromTo(".animate-container.integrate__pic-container .animate__column", {
    rotationY: 0,
    opacity: 1,
    ease: "power2.inOut",
    stagger: 0.6
    ...
    ease: "power2.inOut",
    stagger: 0.6
  }, "-=1.5").fromTo(".animate-container.ship__pic-container .animate__column", {
    rotationY: 90,
    opacity: 0,
    y: -950
  }, {
    ...
    stagger: 0.6,
    ease: "power2.out"
  }, "-=1.8").fromTo(".animate-container.ship__pic-container .animate__column", {
    y: -950,
    ease: "power2.out"
  }, {
    y: -800,
...
function setupMobileAnimations() {
  ...
  tl.fromTo(".integrate__title", {
    ...
    y: 200,
    duration: 2
  }, "+=1.5").fromTo(".animate-container.integrate__pic-container .animate__column", {
    y: -400
  }, {
    y: 100,
    opacity: 1,
    duration: 5,
    ease: "none"
  }, "-=5.2").fromTo(".animate-container.integrate__pic-container .animate__column", {
    rotationY: 0,
    opacity: 1,
    ease: "power2.inOut"
  }, {
    ...
    ease: "power2.inOut",
    stagger: 0.2
  }, "-=0.5").fromTo(".animate-container.ship__pic-container .animate__column", {
    rotationY: 90,
    opacity: 0,
    y: -400
  }, {
...
window.addEventListener("resize", () => {
  ScrollTrigger_ScrollTrigger.getAll().forEach(st => st.kill());
  initAnimations();
});
;// ./src/js/main.js
